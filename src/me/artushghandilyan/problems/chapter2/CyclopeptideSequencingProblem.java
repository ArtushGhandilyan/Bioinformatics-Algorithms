...
public class CyclopeptideSequencingProblem {
    ...
    public static void main(String[] args) {
        ArrayList<Integer> spectrum = new ArrayList<Integer>(Arrays.asList(0, 113, 128, 186, 241, 299, 314, 427));
    ...
    public static ArrayList<Integer> getSpectrum(ArrayList<Integer> candidate, boolean isLinear) {
